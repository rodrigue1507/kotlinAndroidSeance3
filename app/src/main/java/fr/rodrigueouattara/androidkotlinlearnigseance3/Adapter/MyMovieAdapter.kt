package fr.rodrigueouattara.androidkotlinlearnigseance3.Adapter
...
import fr.rodrigueouattara.androidkotlinlearnigseance3.R
...
class MyMovieAdapter(private val context: Context, private val movieList: MutableList<Movie>): RecyclerView.Adapter<MyMovieAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.txt_createdby.text = movieList[position].createby
    }
